...
import { Calendar, Clock, MapPin, Users, Tag, Filter, ChevronRight, Heart, Share2, BookOpen } from 'lucide-react';
  ...
  const events: Event[] = [
    {
      ...
      description: "Join us for an intimate conversation with bestselling author Sarah Johnson as she discusses her latest novel and the creative writing process.",
      date: "2025-12-05",
    ...
    },
    {
      ...
      description: "A magical storytelling session for children ages 4-8, featuring winter-themed stories and interactive activities.",
      date: "2025-12-07",
    ...
    },
    {
      ...
      description: "Learn essential digital skills including internet safety, email management, and social media basics. Perfect for beginners!",
      date: "2025-12-10",
    ...
    },
    {
      ...
      description: "This month we're discussing 'Pride and Prejudice' by Jane Austen. All are welcome to join our lively discussion!",
      date: "2025-12-12",
    ...
    },
    {
      ...
      description: "Board games, video games, and fun for teens ages 13-17. Pizza and snacks provided!",
      date: "2025-12-14",
    ...
    },
    {
      ...
      description: "Celebrate the opening of our new photography exhibition featuring local artists. Wine and cheese reception included.",
      date: "2025-12-16",
    ...
    },
    {
      ...
      description: "Share your work, get feedback, and connect with fellow writers in a supportive environment.",
      date: "2025-12-18",
    ...
    },
    {
      ...
      description: "Create beautiful holiday decorations and gifts. All materials provided. Perfect for all ages!",
      date: "2025-12-20",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">Library Events</h1>
                <p className="text-gray-600 mt-1">Discover upcoming programs and activities</p>
              </div>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {events.filter(e => e.featured).map(event => (
              <div key={event.id} className="relative bg-gradient-to-br from-blue-600 to-indigo-700 rounded-lg overflow-hidden shadow-lg">
                ...
                <div className="space-y-2 mb-4">
                  ...
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <span className={`px-2 py-1 rounded-full text-xs font-semibold ${
                      getAvailabilityColor(event.registered, event.capacity)
                    }`}>
        ...
        <div className="mt-12 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl shadow-xl p-8 text-center text-white">
          ...
          <p className="text-xl text-blue-100 mb-6 max-w-2xl mx-auto">
            Subscribe to our newsletter and get notified about upcoming events and programs.
          </p>
